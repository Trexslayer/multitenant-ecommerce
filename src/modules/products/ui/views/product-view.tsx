...
const CartButton = dynamic(
    ...
    {
        ssr: false,
        loading: ()=> <Button disabled className="flex-1 bg-green-400">Loading...</Button>
    },
);
...
export const ProductView = ({productId,tenantSlug}:Pops)=>{
    const trpc = useTRPC();
                    ...
                    <div className="col-span-4">
                        ...
                        <div className="border-y flex ">
                            <div className="px-6 py-4 items-center justify-center border-r">
                                <div className="relative px-12 py-1 border bg-green-400 w-fit">
                        ...
                        <div className="p-6">
                            {
                                data.description?(<p>{data.description}</p>):(<p className="font-medium text-muted-foreground italic">No description provided</p>)
                            }
                        </div>
                    </div>
